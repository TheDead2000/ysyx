...
VL_ATTR_COLD void VysyxSoCFull___024root___ctor_var_reset(VysyxSoCFull___024root* vlSelf) {
    ...
    vlSelf->ysyxSoCFull__DOT__psram__DOT__addr_temp = 0;
    vlSelf->ysyxSoCFull__DOT__psram__DOT__wdata = 0;
    vlSelf->ysyxSoCFull__DOT__psram__DOT__rdata_temp = 0;
    vlSelf->ysyxSoCFull__DOT__psram__DOT__addr = 0;
    vlSelf->ysyxSoCFull__DOT__psram__DOT____VdfgTmp_h8b176a3d__0 = 0;
    ...
    vlSelf->__Vtask_psram_wr__70__rdata = 0;
