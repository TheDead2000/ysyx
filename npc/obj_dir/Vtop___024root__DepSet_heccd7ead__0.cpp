    ...
    if (((0x63U == (0x7fU & vlSelf->top__DOT__u_icache_top__DOT__icache_final_data)) 
        ...
        if (vlSelf->top__DOT__ifu__DOT__bpu__DOT__is_ret) {
            ...
            if (VL_UNLIKELY(((IData)(vlSelf->top__DOT__ifu__DOT__bpu__DOT__ex_is_ret) 
                ...
                VL_WRITEF("[RAS] COMBO POP: target=0x%x\n",
                          32,vlSelf->top__DOT__bpu_pc_o);
            } else if (VL_UNLIKELY(vlSelf->top__DOT__ifu__DOT__bpu__DOT__ras_held_valid)) {
...
VL_INLINE_OPT void Vtop___024root___nba_sequent__TOP__1(Vtop___024root* vlSelf) {
    ...
    } else if (VL_UNLIKELY(((IData)(vlSelf->top__DOT__ifu__DOT__bpu__DOT__is_ret) 
