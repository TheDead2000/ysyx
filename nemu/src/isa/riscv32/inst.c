...
#define INSTPAT_MATCH(s, name, type, ... /* body */ ) { \
  ...
  INSTPAT("0000000 ????? ????? 001 ????? 01100 11", sll, R, R(dest) = U64(src1) << BITS(src2, 5, 0));
  INSTPAT("0000000 ????? ????? 101 ????? 01100 11", srl, R, R(dest) = U64(src1) >> BITS(src2, 5, 0));
  INSTPAT("0100000 ????? ????? 101 ????? 01100 11", sra, R, R(dest) = S64(src1) >> BITS(src2, 5, 0));
  INSTPAT("0000000 ????? ????? 010 ????? 01100 11", slt, R, R(dest) = (S64(src1) < S64(src2)) ? 1 : 0);
  INSTPAT("0000000 ????? ????? 011 ????? 01100 11", sltu, R, R(dest) = (U64(src1) < U64(src2)) ? 1 : 0);
  ...
  INSTPAT("000000? ????? ????? 001 ????? 00100 11", slli, I, R(dest) = U64(src1) << BITS(src2, 5, 0)); //rv64
  INSTPAT("000000? ????? ????? 101 ????? 00100 11", srli, I, R(dest) = U64(src1) >> BITS(src2, 5, 0)); //rv64
  INSTPAT("010000? ????? ????? 101 ????? 00100 11", srai, I, R(dest) = S64(src1) >> BITS(src2, 5, 0)); //rv64
  INSTPAT("??????? ????? ????? 010 ????? 00100 11", slti, I, R(dest) = (S64(src1) < S64(src2)) ? 1 : 0);
  ...
  INSTPAT("??????? ????? ????? 011 ????? 00000 11", ld, I, R(dest) = Mr(src1 + src2, 8)); // rv64
  INSTPAT("??????? ????? ????? 100 ????? 00000 11", lbu, I, R(dest) = Mr(src1 + src2, 1));
  INSTPAT("??????? ????? ????? 101 ????? 00000 11", lhu, I, R(dest) = Mr(src1 + src2, 2));
  INSTPAT("??????? ????? ????? 110 ????? 00000 11", lwu, I, R(dest) = Mr(src1 + src2, 4)); //rv64
  INSTPAT("??????? ????? ????? 000 ????? 01000 11", sb, S, Mw(src1 + dest, 1, src2));
  INSTPAT("??????? ????? ????? 001 ????? 01000 11", sh, S, Mw(src1 + dest, 2, src2));
  INSTPAT("??????? ????? ????? 010 ????? 01000 11", sw, S, Mw(src1 + dest, 4, src2));
  INSTPAT("??????? ????? ????? 011 ????? 01000 11", sd, S, Mw(src1 + dest, 8, src2)); //rv64
  ...
  INSTPAT("000000? ????? ????? 001 ????? 00110 11", slliw, I, R(dest) = SEXT(U32(src1) << BITS(src2, 4, 0), 32));
  INSTPAT("000000? ????? ????? 101 ????? 00110 11", srliw, I, R(dest) = SEXT(U32(src1) >> BITS(src2, 4, 0), 32));
  INSTPAT("010000? ????? ????? 101 ????? 00110 11", sraiw, I, R(dest) = SEXT(S32(src1) >> BITS(src2, 4, 0), 32));
  INSTPAT("010000? ????? ????? 101 ????? 00110 11", sraiw, I, R(dest) = SEXT(S32(src1) >> BITS(src2, 4, 0), 32));
  ...
  INSTPAT("0000000 ????? ????? 001 ????? 01110 11", sllw, R, R(dest) = SEXT(U32(src1) << BITS(src2, 4, 0), 32));
  INSTPAT("0000000 ????? ????? 101 ????? 01110 11", srlw, R, R(dest) = SEXT(U32(src1) >> BITS(src2, 4, 0), 32));//很奇怪
  INSTPAT("0100000 ????? ????? 101 ????? 01110 11", sraw, R, R(dest) = SEXT(S32(src1) >> BITS(src2, 4, 0), 32));


  /* mul */
  __int128_t mulTemp = 0;
  INSTPAT("0000001 ????? ????? 000 ????? 01100 11", mul, R, R(dest) = src1 * src2);
  INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulh, R, mulTemp = S64(src1) * S64(src2), R(dest) = mulTemp >> 64);
  INSTPAT("0000001 ????? ????? 010 ????? 01100 11", mulhsu, R, mulTemp = S64(src1) * U64(src2), R(dest) = mulTemp >> 64);
  INSTPAT("0000001 ????? ????? 011 ????? 01100 11", mulhu, R, mulTemp = U64(src1) * U64(src2), R(dest) = mulTemp >> 64);
  ...
  // rv64
  INSTPAT("0000001 ????? ????? 000 ????? 01110 11", mulw, R, R(dest) = SEXT(BITS(S32(src1) * S32(src2), 31, 0), 32));
  INSTPAT("0000001 ????? ????? 100 ????? 01110 11", divw, R, R(dest) = SEXT(S32(src1) / S32(src2), 32));
  INSTPAT("0000001 ????? ????? 101 ????? 01110 11", divuw, R, R(dest) = SEXT(U32(src1) / U32(src2), 32));
  INSTPAT("0000001 ????? ????? 110 ????? 01110 11", remw, R, R(dest) = SEXT(S32(src1) % S32(src2), 32));
  INSTPAT("0000001 ????? ????? 111 ????? 01110 11", remuw, R, R(dest) = SEXT(U32(src1) % U32(src2), 32));
  /* other */
