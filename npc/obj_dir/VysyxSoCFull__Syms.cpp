    ...
    , TOP____024unit{this, Verilated::catName(namep, "$unit")}
{
    ...
    __Vscope_ysyxSoCFull__asic__cpu__cpu__top_core__clint_u.configure(this, name(), "ysyxSoCFull.asic.cpu.cpu.top_core.clint_u", "clint_u", -9, VerilatedScope::SCOPE_OTHER);
