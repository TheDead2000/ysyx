...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+385,"history_o", false,-1, 15,0);
    ...
    tracep->declBus(c+84,"bpu_pdt_tag_id_ex", false,-1, 31,0);
    ...
    tracep->declBus(c+85,"exc_alu_data_ex", false,-1, 31,0);
    ...
    tracep->declBus(c+79,"ex_pc_o", false,-1, 31,0);
    ...
    tracep->declBus(c+87,"pc_ex_mem", false,-1, 31,0);
    tracep->declBus(c+88,"inst_data_ex_mem", false,-1, 31,0);
    tracep->declBus(c+89,"imm_data_ex_mem", false,-1, 31,0);
    tracep->declBus(c+90,"rd_idx_ex_mem", false,-1, 4,0);
    tracep->declBus(c+91,"rs1_data_ex_mem", false,-1, 31,0);
    tracep->declBus(c+92,"rs2_data_ex_mem", false,-1, 31,0);
    tracep->declBus(c+93,"alu_data_ex_mem", false,-1, 31,0);
    tracep->declBus(c+94,"pc_op_ex_mem", false,-1, 3,0);
    tracep->declBus(c+95,"mem_op_ex_mem", false,-1, 3,0);
    tracep->declBus(c+96,"trap_bus_ex_mem", false,-1, 18,0);
    tracep->declBus(c+87,"pc_mem", false,-1, 31,0);
    tracep->declBus(c+88,"inst_data_mem", false,-1, 31,0);
    tracep->declBus(c+97,"mem_data_mem", false,-1, 31,0);
    tracep->declBus(c+90,"rd_idx_mem", false,-1, 4,0);
    tracep->declBus(c+98,"trap_bus_mem", false,-1, 18,0);
    tracep->declBus(c+99,"mem_addr", false,-1, 31,0);
    tracep->declBit(c+100,"mem_addr_valid", false,-1);
    tracep->declBus(c+101,"mem_mask", false,-1, 3,0);
    tracep->declBus(c+102,"mem_rdata", false,-1, 31,0);
    tracep->declBus(c+103,"mem_wdata", false,-1, 31,0);
    tracep->declBus(c+104,"mem_size", false,-1, 3,0);
    tracep->declBit(c+105,"mem_write_valid", false,-1);
    tracep->declBit(c+106,"mem_data_ready", false,-1);
    tracep->declBit(c+100,"ram_stall_valid_mem", false,-1);
    ...
    tracep->declBus(c+107,"rs1_data_gpr", false,-1, 31,0);
    tracep->declBus(c+108,"rs2_data_gpr", false,-1, 31,0);
    tracep->declBit(c+3,"commit_valid", false,-1);
    tracep->declBus(c+473,"clint_pc", false,-1, 31,0);
    tracep->declBit(c+109,"clint_pc_valid", false,-1);
    tracep->declBus(c+16,"stall_clint", false,-1, 5,0);
    tracep->declBus(c+17,"flush_clint", false,-1, 5,0);
    tracep->declBus(c+110,"ram_raddr_icache", false,-1, 31,0);
    tracep->declBit(c+111,"ram_raddr_valid_icache", false,-1);
    tracep->declBus(c+112,"ram_rmask_icache", false,-1, 3,0);
    tracep->declBus(c+113,"ram_rsize_icache", false,-1, 3,0);
    tracep->declBus(c+114,"ram_rlen_icache", false,-1, 7,0);
    tracep->declBit(c+115,"ram_rdata_ready_icache", false,-1);
    tracep->declBus(c+116,"ram_rdata_icache", false,-1, 31,0);
    tracep->declBus(c+117,"ram_raddr_dcache", false,-1, 31,0);
    tracep->declBit(c+118,"ram_raddr_valid_dcache", false,-1);
    tracep->declBus(c+119,"ram_rmask_dcache", false,-1, 3,0);
    tracep->declBus(c+120,"ram_rsize_dcache", false,-1, 3,0);
    tracep->declBus(c+121,"ram_rlen_dcache", false,-1, 7,0);
    tracep->declBit(c+122,"ram_rdata_ready_dcache", false,-1);
    tracep->declBus(c+123,"ram_rdata_dcache", false,-1, 31,0);
    tracep->declBus(c+124,"ram_waddr_dcache", false,-1, 31,0);
    tracep->declBit(c+125,"ram_waddr_valid_dcache", false,-1);
    tracep->declBus(c+126,"ram_wmask_dcache", false,-1, 3,0);
    tracep->declBit(c+127,"ram_wdata_ready_dcache", false,-1);
    tracep->declBus(c+435,"ram_wdata_dcache", false,-1, 31,0);
    tracep->declBus(c+128,"ram_wsize_dcache", false,-1, 3,0);
    tracep->declBus(c+129,"ram_wlen_dcache", false,-1, 7,0);
    tracep->declBus(c+130,"arb_read_addr", false,-1, 31,0);
    tracep->declBit(c+131,"arb_raddr_valid", false,-1);
    tracep->declBus(c+132,"arb_rmask", false,-1, 3,0);
    tracep->declBus(c+133,"arb_rsize", false,-1, 3,0);
    tracep->declBus(c+134,"arb_rlen", false,-1, 7,0);
    tracep->declBus(c+135,"arb_rdata", false,-1, 31,0);
    tracep->declBit(c+136,"arb_rdata_ready", false,-1);
    tracep->declBit(c+137,"arb_rlast", false,-1);
    tracep->declBus(c+124,"arb_write_addr", false,-1, 31,0);
    tracep->declBit(c+125,"arb_write_valid", false,-1);
    tracep->declBus(c+126,"arb_wmask", false,-1, 3,0);
    tracep->declBus(c+435,"arb_wdata", false,-1, 31,0);
    tracep->declBus(c+128,"arb_wsize", false,-1, 3,0);
    tracep->declBus(c+129,"arb_wlen", false,-1, 7,0);
    tracep->declBit(c+127,"arb_wdata_ready", false,-1);
    ...
    tracep->declBus(c+138,"io_sram0_addr", false,-1, 6,0);
    tracep->declBit(c+476,"io_sram0_cen", false,-1);
    tracep->declBit(c+139,"io_sram0_wen", false,-1);
    tracep->declArray(c+140,"io_sram0_wmask", false,-1, 127,0);
    tracep->declArray(c+144,"io_sram0_wdata", false,-1, 127,0);
    tracep->declArray(c+148,"io_sram0_rdata", false,-1, 127,0);
    tracep->declBus(c+138,"io_sram1_addr", false,-1, 6,0);
    tracep->declBit(c+476,"io_sram1_cen", false,-1);
    tracep->declBit(c+152,"io_sram1_wen", false,-1);
    tracep->declArray(c+140,"io_sram1_wmask", false,-1, 127,0);
    tracep->declArray(c+144,"io_sram1_wdata", false,-1, 127,0);
    tracep->declArray(c+153,"io_sram1_rdata", false,-1, 127,0);
    tracep->declBus(c+138,"io_sram2_addr", false,-1, 6,0);
    tracep->declBit(c+476,"io_sram2_cen", false,-1);
    tracep->declBit(c+157,"io_sram2_wen", false,-1);
    tracep->declArray(c+140,"io_sram2_wmask", false,-1, 127,0);
    tracep->declArray(c+144,"io_sram2_wdata", false,-1, 127,0);
    tracep->declArray(c+158,"io_sram2_rdata", false,-1, 127,0);
    tracep->declBus(c+138,"io_sram3_addr", false,-1, 6,0);
    tracep->declBit(c+476,"io_sram3_cen", false,-1);
    tracep->declBit(c+162,"io_sram3_wen", false,-1);
    tracep->declArray(c+140,"io_sram3_wmask", false,-1, 127,0);
    tracep->declArray(c+144,"io_sram3_wdata", false,-1, 127,0);
    tracep->declArray(c+163,"io_sram3_rdata", false,-1, 127,0);
    tracep->declBus(c+39,"io_sram4_addr", false,-1, 6,0);
    tracep->declBit(c+476,"io_sram4_cen", false,-1);
    tracep->declBit(c+167,"io_sram4_wen", false,-1);
    tracep->declArray(c+168,"io_sram4_wmask", false,-1, 127,0);
    tracep->declArray(c+172,"io_sram4_wdata", false,-1, 127,0);
    tracep->declArray(c+176,"io_sram4_rdata", false,-1, 127,0);
    tracep->declBus(c+39,"io_sram5_addr", false,-1, 6,0);
    tracep->declBit(c+476,"io_sram5_cen", false,-1);
    tracep->declBit(c+180,"io_sram5_wen", false,-1);
    tracep->declArray(c+168,"io_sram5_wmask", false,-1, 127,0);
    tracep->declArray(c+172,"io_sram5_wdata", false,-1, 127,0);
    tracep->declArray(c+181,"io_sram5_rdata", false,-1, 127,0);
    tracep->declBus(c+39,"io_sram6_addr", false,-1, 6,0);
    tracep->declBit(c+476,"io_sram6_cen", false,-1);
    tracep->declBit(c+185,"io_sram6_wen", false,-1);
    tracep->declArray(c+168,"io_sram6_wmask", false,-1, 127,0);
    tracep->declArray(c+172,"io_sram6_wdata", false,-1, 127,0);
    tracep->declArray(c+186,"io_sram6_rdata", false,-1, 127,0);
    tracep->declBus(c+39,"io_sram7_addr", false,-1, 6,0);
    tracep->declBit(c+476,"io_sram7_cen", false,-1);
    tracep->declBit(c+190,"io_sram7_wen", false,-1);
    tracep->declArray(c+168,"io_sram7_wmask", false,-1, 127,0);
    tracep->declArray(c+172,"io_sram7_wdata", false,-1, 127,0);
    tracep->declArray(c+191,"io_sram7_rdata", false,-1, 127,0);
    ...
    tracep->declBus(c+130,"arb_read_addr_i", false,-1, 31,0);
    tracep->declBit(c+131,"arb_raddr_valid_i", false,-1);
    tracep->declBus(c+132,"arb_rmask_i", false,-1, 3,0);
    tracep->declBus(c+133,"arb_rsize_i", false,-1, 3,0);
    tracep->declBus(c+134,"arb_rlen_i", false,-1, 7,0);
    tracep->declBus(c+135,"arb_rdata_o", false,-1, 31,0);
    tracep->declBit(c+136,"arb_rdata_ready_o", false,-1);
    tracep->declBit(c+137,"arb_rlast_o", false,-1);
    tracep->declBus(c+124,"arb_write_addr_i", false,-1, 31,0);
    tracep->declBit(c+125,"arb_write_valid_i", false,-1);
    tracep->declBus(c+126,"arb_wmask_i", false,-1, 3,0);
    tracep->declBus(c+128,"arb_wsize_i", false,-1, 3,0);
    tracep->declBus(c+129,"arb_wlen_i", false,-1, 7,0);
    tracep->declBus(c+435,"arb_wdata_i", false,-1, 31,0);
    tracep->declBit(c+127,"arb_wdata_ready_o", false,-1);
    ...
    tracep->declBus(c+195,"to_aw_size", false,-1, 2,0);
    tracep->declBus(c+196,"axi_wstate", false,-1, 2,0);
    tracep->declBus(c+197,"aw_addr", false,-1, 31,0);
    tracep->declBit(c+198,"aw_valid", false,-1);
    tracep->declBus(c+199,"aw_len", false,-1, 7,0);
    tracep->declBus(c+200,"aw_size", false,-1, 2,0);
    tracep->declBus(c+201,"w_strb", false,-1, 3,0);
    tracep->declBit(c+202,"w_valid", false,-1);
    tracep->declBit(c+203,"w_last", false,-1);
    tracep->declBit(c+204,"b_ready", false,-1);
    tracep->declBus(c+205,"burst_count", false,-1, 7,0);
    tracep->declBus(c+206,"burst_count_plus1", false,-1, 7,0);
    ...
    tracep->declBus(c+207,"to_ar_size", false,-1, 2,0);
    tracep->declBus(c+208,"axi_rstate", false,-1, 2,0);
    tracep->declBit(c+209,"ar_valid", false,-1);
    tracep->declBus(c+210,"ar_addr", false,-1, 31,0);
    tracep->declBus(c+211,"ar_size", false,-1, 2,0);
    tracep->declBus(c+212,"ar_len", false,-1, 7,0);
    tracep->declBit(c+213,"r_ready", false,-1);
    ...
    tracep->declBit(c+424,"clk", false,-1);
    tracep->declBit(c+425,"rst", false,-1);
    tracep->declBus(c+110,"if_read_addr_i", false,-1, 31,0);
    tracep->declBit(c+111,"if_raddr_valid_i", false,-1);
    tracep->declBus(c+112,"if_rmask_i", false,-1, 3,0);
    tracep->declBus(c+113,"if_rsize_i", false,-1, 3,0);
    tracep->declBus(c+114,"if_rlen_i", false,-1, 7,0);
    tracep->declBus(c+116,"if_rdata_o", false,-1, 31,0);
    tracep->declBit(c+115,"if_rdata_ready_o", false,-1);
    tracep->declBus(c+117,"mem_read_addr_i", false,-1, 31,0);
    tracep->declBit(c+118,"mem_raddr_valid_i", false,-1);
    tracep->declBus(c+119,"mem_rmask_i", false,-1, 3,0);
    tracep->declBus(c+120,"mem_rsize_i", false,-1, 3,0);
    tracep->declBus(c+121,"mem_rlen_i", false,-1, 7,0);
    tracep->declBus(c+123,"mem_rdata_o", false,-1, 31,0);
    tracep->declBit(c+122,"mem_rdata_ready_o", false,-1);
    tracep->declBit(c+137,"arb_rlast_i", false,-1);
    tracep->declBus(c+124,"mem_write_addr_i", false,-1, 31,0);
    tracep->declBit(c+125,"mem_write_valid_i", false,-1);
    tracep->declBus(c+126,"mem_wmask_i", false,-1, 3,0);
    tracep->declBus(c+435,"mem_wdata_i", false,-1, 31,0);
    tracep->declBus(c+128,"mem_wsize_i", false,-1, 3,0);
    tracep->declBus(c+129,"mem_wlen_i", false,-1, 7,0);
    tracep->declBit(c+127,"mem_wdata_ready_o", false,-1);
    tracep->declBus(c+130,"arb_read_addr_o", false,-1, 31,0);
    tracep->declBit(c+131,"arb_raddr_valid_o", false,-1);
    tracep->declBus(c+132,"arb_rmask_o", false,-1, 3,0);
    tracep->declBus(c+133,"arb_rsize_o", false,-1, 3,0);
    tracep->declBus(c+134,"arb_rlen_o", false,-1, 7,0);
    tracep->declBus(c+135,"arb_rdata_i", false,-1, 31,0);
    tracep->declBit(c+136,"arb_rdata_ready_i", false,-1);
    tracep->declBus(c+124,"arb_write_addr_o", false,-1, 31,0);
    tracep->declBit(c+125,"arb_write_valid_o", false,-1);
    tracep->declBus(c+126,"arb_wmask_o", false,-1, 3,0);
    tracep->declBus(c+435,"arb_wdata_o", false,-1, 31,0);
    tracep->declBus(c+128,"arb_wsize_o", false,-1, 3,0);
    tracep->declBus(c+129,"arb_wlen_o", false,-1, 7,0);
    tracep->declBit(c+127,"arb_wdata_ready_i", false,-1);
    ...
    tracep->declBus(c+214,"arb_state", false,-1, 1,0);
    tracep->declBit(c+215,"if_read_state", false,-1);
    tracep->declBit(c+216,"mem_read_state", false,-1);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("clint_u ");
    tracep->declBit(c+425,"rst", false,-1);
    tracep->declBus(c+87,"pc_i", false,-1, 31,0);
    tracep->declBus(c+88,"inst_data_i", false,-1, 31,0);
    tracep->declBus(c+98,"trap_bus_i", false,-1, 18,0);
    ...
    tracep->declBit(c+109,"clint_pc_valid_o", false,-1);
    ...
    tracep->declBit(c+100,"ram_stall_valid_mem_i", false,-1);
    ...
    tracep->declBit(c+217,"ram_stall_req", false,-1);
    tracep->popNamePrefix(1);
    ...
    tracep->declBus(c+85,"alu_data_ex_mem_i", false,-1, 31,0);
    ...
    tracep->declBus(c+87,"inst_addr_ex_mem_o", false,-1, 31,0);
    tracep->declBus(c+88,"inst_data_ex_mem_o", false,-1, 31,0);
    tracep->declBus(c+89,"imm_data_ex_mem_o", false,-1, 31,0);
    tracep->declBus(c+90,"rd_idx_ex_mem_o", false,-1, 4,0);
    tracep->declBus(c+91,"rs1_data_ex_mem_o", false,-1, 31,0);
    tracep->declBus(c+92,"rs2_data_ex_mem_o", false,-1, 31,0);
    tracep->declBus(c+93,"alu_data_ex_mem_o", false,-1, 31,0);
    tracep->declBus(c+94,"pc_op_ex_mem_o", false,-1, 3,0);
    tracep->declBus(c+95,"mem_op_ex_mem_o", false,-1, 3,0);
    tracep->declBus(c+96,"trap_bus_ex_mem_o", false,-1, 18,0);
    ...
    tracep->declBus(c+84,"pdt_tag_i", false,-1, 31,0);
    ...
    tracep->declBus(c+85,"exc_alu_data_o", false,-1, 31,0);
    ...
    tracep->declBit(c+218,"valid_prediction", false,-1);
    ...
    tracep->declBus(c+219,"alu_a_i", false,-1, 31,0);
    tracep->declBus(c+220,"alu_b_i", false,-1, 31,0);
    tracep->declBus(c+75,"alu_op_i", false,-1, 4,0);
    tracep->declBus(c+85,"alu_out_o", false,-1, 31,0);
    tracep->declBit(c+221,"compare_out_o", false,-1);
    tracep->pushNamePrefix("u_alu_shift ");
    tracep->declBit(c+222,"shift_sra_i", false,-1);
    tracep->declBit(c+223,"shift_srl_i", false,-1);
    tracep->declBit(c+224,"shift_sll_i", false,-1);
    tracep->declBus(c+219,"shift_num_i", false,-1, 31,0);
    tracep->declBus(c+225,"shift_count_i", false,-1, 4,0);
    tracep->declBus(c+226,"shift_out_o", false,-1, 31,0);
    tracep->pushNamePrefix("u_Vectorinvert1 ");
    tracep->declBus(c+479,"DATA_LEN", false,-1, 31,0);
    tracep->declBus(c+219,"in", false,-1, 31,0);
    tracep->declBus(c+227,"out", false,-1, 31,0);
    tracep->declBus(c+506,"i", false,-1, 31,0);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("u_Vectorinvert2 ");
    tracep->declBus(c+479,"DATA_LEN", false,-1, 31,0);
    tracep->declBus(c+228,"in", false,-1, 31,0);
    ...
    tracep->declBus(c+84,"bpu_pdt_tag_id_ex_o", false,-1, 31,0);
    ...
    tracep->declBus(c+107,"rs1_data_i", false,-1, 31,0);
    tracep->declBus(c+108,"rs2_data_i", false,-1, 31,0);
    ...
    tracep->declBus(c+85,"ex_rd_data_i", false,-1, 31,0);
    tracep->declBus(c+51,"ex_rd_addr_i", false,-1, 4,0);
    tracep->declBus(c+97,"mem_rd_data_i", false,-1, 31,0);
    tracep->declBus(c+90,"mem_rd_addr_i", false,-1, 4,0);
    ...
    tracep->declBus(c+385,"bpu_history_if_i", false,-1, 15,0);
    ...
    tracep->declBus(c+385,"din", false,-1, 15,0);
    ...
    tracep->declBus(c+385,"global_history", false,-1, 15,0);
    tracep->declBus(c+386,"ras_sp", false,-1, 5,0);
    tracep->declBus(c+387,"pred_ras_sp", false,-1, 5,0);
    tracep->declBit(c+463,"pred_used_ras", false,-1);
    tracep->declBus(c+388,"provider_history_reg", false,-1, 1,0);
    tracep->declBus(c+40,"provider_history_comb", false,-1, 1,0);
    tracep->declBus(c+389,"total_branches", false,-1, 31,0);
    tracep->declBus(c+390,"correct_predictions", false,-1, 31,0);
    tracep->declBus(c+391,"bimodal_hits", false,-1, 31,0);
    tracep->declBus(c+392,"t0_hits", false,-1, 31,0);
    tracep->declBus(c+393,"t1_hits", false,-1, 31,0);
    tracep->declBus(c+230,"btb_hits", false,-1, 31,0);
    tracep->declBus(c+231,"btb_misses", false,-1, 31,0);
    tracep->declBus(c+2,"i", false,-1, 31,0);
    tracep->declBit(c+394,"ras_forward_valid", false,-1);
    tracep->declBus(c+395,"ras_forward_data", false,-1, 31,0);
    tracep->declBit(c+396,"ras_forward_used", false,-1);
    tracep->declBus(c+397,"next_sp", false,-1, 5,0);
    tracep->declBit(c+398,"pop_occurred", false,-1);
    tracep->declBus(c+399,"pop_index", false,-1, 5,0);
    ...
    tracep->declBit(c+232,"is_branch", false,-1);
    tracep->declBit(c+233,"is_jal", false,-1);
    tracep->declBit(c+234,"is_jalr", false,-1);
    tracep->declBit(c+416,"is_ret", false,-1);
    tracep->declBit(c+417,"ex_is_ret", false,-1);
    tracep->declBus(c+235,"branch_offset", false,-1, 31,0);
    ...
    tracep->declBus(c+236,"t0_index_u", false,-1, 7,0);
    tracep->declBus(c+237,"t1_index_u", false,-1, 7,0);
    tracep->declBus(c+238,"t0_tag_u", false,-1, 9,0);
    tracep->declBus(c+239,"t1_tag_u", false,-1, 9,0);
    tracep->declBus(c+240,"bm_index_u", false,-1, 8,0);
    tracep->declBus(c+241,"btb_index_u", false,-1, 7,0);
    tracep->declBus(c+242,"btb_tag_u", false,-1, 21,0);
    ...
    tracep->declBus(c+243,"btb_hit_rate", false,-1, 31,0);
    tracep->popNamePrefix(2);
    tracep->pushNamePrefix("lsu ");
    tracep->declBit(c+424,"clk", false,-1);
    tracep->declBit(c+425,"rst", false,-1);
    tracep->declBus(c+87,"inst_addr_i", false,-1, 31,0);
    tracep->declBus(c+88,"inst_data_i", false,-1, 31,0);
    tracep->declBus(c+90,"rd_idx_i", false,-1, 4,0);
    tracep->declBus(c+92,"rs2_data_i", false,-1, 31,0);
    tracep->declBus(c+95,"mem_op_i", false,-1, 3,0);
    tracep->declBus(c+93,"exc_alu_data_i", false,-1, 31,0);
    tracep->declBus(c+96,"trap_bus_i", false,-1, 18,0);
    tracep->declBus(c+87,"inst_addr_o", false,-1, 31,0);
    tracep->declBus(c+88,"inst_data_o", false,-1, 31,0);
    tracep->declBus(c+97,"mem_data_o", false,-1, 31,0);
    tracep->declBus(c+90,"rd_idx_o", false,-1, 4,0);
    tracep->declBus(c+98,"trap_bus_o", false,-1, 18,0);
    tracep->declBus(c+99,"mem_addr_o", false,-1, 31,0);
    tracep->declBit(c+100,"mem_addr_valid_o", false,-1);
    tracep->declBus(c+101,"mem_mask_o", false,-1, 3,0);
    tracep->declBit(c+105,"mem_write_valid_o", false,-1);
    tracep->declBus(c+104,"mem_size_o", false,-1, 3,0);
    tracep->declBit(c+106,"mem_data_ready_i", false,-1);
    tracep->declBus(c+102,"mem_rdata_i", false,-1, 31,0);
    tracep->declBus(c+103,"mem_wdata_o", false,-1, 31,0);
    tracep->declBit(c+100,"ram_stall_valid_mem_o", false,-1);
    tracep->declBit(c+244,"ls_signed", false,-1);
    tracep->declBus(c+245,"mem_rdata", false,-1, 31,0);
    tracep->declBus(c+246,"mem_rdata_ext", false,-1, 31,0);
    tracep->declBit(c+247,"ls1byte", false,-1);
    tracep->declBit(c+248,"ls2byte", false,-1);
    tracep->declBit(c+249,"ls4byte", false,-1);
    tracep->declBus(c+104,"ls_size", false,-1, 3,0);
    tracep->declBus(c+250,"addr_last2", false,-1, 1,0);
    tracep->declBus(c+251,"rmask", false,-1, 3,0);
    tracep->declBus(c+252,"wmask", false,-1, 3,0);
    tracep->declBit(c+253,"ls_valid", false,-1);
    tracep->declBus(c+505,"i", false,-1, 31,0);
    tracep->pushNamePrefix("lsu_ext_load ");
    tracep->declBus(c+245,"ext_data_i", false,-1, 31,0);
    tracep->declBit(c+244,"ls_signed_i", false,-1);
    tracep->declBus(c+104,"ls_size_i", false,-1, 3,0);
    tracep->declBus(c+246,"ext_data_o", false,-1, 31,0);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("lsu_ext_store ");
    tracep->declBus(c+92,"ext_data_i", false,-1, 31,0);
    tracep->declBit(c+476,"ls_signed_i", false,-1);
    tracep->declBus(c+104,"ls_size_i", false,-1, 3,0);
    tracep->declBus(c+254,"ext_data_o", false,-1, 31,0);
    tracep->popNamePrefix(2);
    ...
    tracep->declBus(c+107,"rs1_data_o", false,-1, 31,0);
    tracep->declBus(c+108,"rs2_data_o", false,-1, 31,0);
    tracep->declBus(c+90,"write_idx_i", false,-1, 4,0);
    tracep->declBus(c+97,"write_data_i", false,-1, 31,0);
    tracep->declBit(c+560,"write_data_valid_i", false,-1);
    for (int i = 0; i < 32; ++i) {
        tracep->declBus(c+255+i*1,"rf", true,(i+0), 31,0);
    }
    tracep->popNamePrefix(1);
    ...
    tracep->declArray(c+296,"bwen", false,-1, 127,0);
    tracep->popNamePrefix(1);
    ...
    tracep->declBit(c+424,"clk", false,-1);
    tracep->declBit(c+425,"rst", false,-1);
    tracep->declBus(c+99,"mem_addr_i", false,-1, 31,0);
    tracep->declBus(c+101,"mem_mask_i", false,-1, 3,0);
    tracep->declBus(c+104,"mem_size_i", false,-1, 3,0);
    tracep->declBit(c+100,"mem_addr_valid_i", false,-1);
    tracep->declBit(c+105,"mem_write_valid_i", false,-1);
    tracep->declBus(c+103,"mem_wdata_i", false,-1, 31,0);
    tracep->declBus(c+102,"mem_rdata_o", false,-1, 31,0);
    tracep->declBit(c+106,"mem_data_ready_o", false,-1);
    tracep->declBus(c+117,"ram_raddr_dcache_o", false,-1, 31,0);
    tracep->declBit(c+118,"ram_raddr_valid_dcache_o", false,-1);
    tracep->declBus(c+119,"ram_rmask_dcache_o", false,-1, 3,0);
    tracep->declBus(c+120,"ram_rsize_dcache_o", false,-1, 3,0);
    tracep->declBus(c+121,"ram_rlen_dcache_o", false,-1, 7,0);
    tracep->declBit(c+122,"ram_rdata_ready_dcache_i", false,-1);
    tracep->declBus(c+123,"ram_rdata_dcache_i", false,-1, 31,0);
    tracep->declBus(c+124,"ram_waddr_dcache_o", false,-1, 31,0);
    tracep->declBit(c+125,"ram_waddr_valid_dcache_o", false,-1);
    tracep->declBus(c+126,"ram_wmask_dcache_o", false,-1, 3,0);
    tracep->declBus(c+128,"ram_wsize_dcache_o", false,-1, 3,0);
    tracep->declBus(c+129,"ram_wlen_dcache_o", false,-1, 7,0);
    tracep->declBit(c+127,"ram_wdata_ready_dcache_i", false,-1);
    ...
    tracep->declArray(c+144,"io_sram3_wdata", false,-1, 127,0);
    tracep->declArray(c+163,"io_sram3_rdata", false,-1, 127,0);
    tracep->declBit(c+303,"uncache", false,-1);
    tracep->declBus(c+304,"cache_blk_addr", false,-1, 5,0);
    tracep->declBus(c+138,"cache_line_idx", false,-1, 6,0);
    tracep->declBus(c+305,"cache_line_tag", false,-1, 18,0);
    tracep->declBit(c+306,"dcache_hit", false,-1);
    tracep->declBus(c+307,"wmask_bit", false,-1, 31,0);
    tracep->declBit(c+308,"dirty_bit_read", false,-1);
    tracep->declBus(c+309,"dcache_tag_read", false,-1, 18,0);
    tracep->declBus(c+310,"dcache_writeback_data", false,-1, 31,0);
    ...
    tracep->declBus(c+311,"dcache_state", false,-1, 3,0);
    tracep->declBus(c+312,"blk_addr_reg", false,-1, 5,0);
    tracep->declBit(c+313,"dcache_tag_wen", false,-1);
    tracep->declBit(c+314,"dcache_data_ready", false,-1);
    tracep->declArray(c+315,"dcache_wdata_writehit", false,-1, 127,0);
    tracep->declBus(c+319,"uncache_rdata", false,-1, 31,0);
    tracep->declBit(c+320,"dcache_data_wen", false,-1);
    tracep->declBit(c+321,"dcache_write_hit_valid", false,-1);
    tracep->declArray(c+322,"dcache_wmask_writehit", false,-1, 127,0);
    tracep->declBus(c+326,"burst_count", false,-1, 3,0);
    tracep->declBus(c+327,"burst_count_plus1", false,-1, 3,0);
    tracep->declBit(c+328,"ram_r_handshake", false,-1);
    tracep->declBit(c+329,"ram_w_handshake", false,-1);
    tracep->declArray(c+330,"dcache_wmask_readmiss", false,-1, 127,0);
    tracep->declArray(c+334,"dcache_wdate_readmiss", false,-1, 127,0);
    tracep->declBit(c+338,"state_readmiss", false,-1);
    tracep->declBit(c+321,"state_writehit", false,-1);
    tracep->declBit(c+339,"state_writeback", false,-1);
    tracep->declArray(c+288,"dcache_wmask", false,-1, 127,0);
    tracep->declArray(c+144,"dcache_wdata", false,-1, 127,0);
    tracep->declBit(c+340,"dcache_wwen", false,-1);
    tracep->declBit(c+341,"dirty_bit_write", false,-1);
    tracep->declBus(c+305,"dcache_tag_write", false,-1, 18,0);
    tracep->declBit(c+342,"dirty_flush", false,-1);
    tracep->declBit(c+338,"dcache_allocate_valid", false,-1);
    tracep->declBit(c+339,"dcache_writeback_valid", false,-1);
    tracep->declBus(c+138,"dcache_index", false,-1, 6,0);
    tracep->declBus(c+343,"dcache_rdata", false,-1, 31,0);
    tracep->pushNamePrefix("u_dcache_data ");
    tracep->declBus(c+562,"IDX_LEN", false,-1, 31,0);
    tracep->declBus(c+555,"BLK_LEN", false,-1, 31,0);
    tracep->declBus(c+138,"dcache_index_i", false,-1, 6,0);
    tracep->declBus(c+304,"dcache_blk_addr_i", false,-1, 5,0);
    tracep->declArray(c+144,"dcache_line_wdata_i", false,-1, 127,0);
    tracep->declArray(c+288,"dcache_wmask", false,-1, 127,0);
    tracep->declBus(c+326,"burst_count_i", false,-1, 3,0);
    tracep->declBit(c+338,"dcache_allocate_valid_i", false,-1);
    tracep->declBit(c+339,"dcache_writeback_valid_i", false,-1);
    tracep->declBit(c+340,"dcache_wen_i", false,-1);
    tracep->declBus(c+310,"dcache_writeback_data_o", false,-1, 31,0);
    tracep->declBus(c+343,"dcache_rdata_o", false,-1, 31,0);
    tracep->declBus(c+138,"io_sram0_addr", false,-1, 6,0);
    tracep->declBit(c+476,"io_sram0_cen", false,-1);
    tracep->declBit(c+139,"io_sram0_wen", false,-1);
    tracep->declArray(c+140,"io_sram0_wmask", false,-1, 127,0);
    ...
    tracep->declArray(c+144,"io_sram3_wdata", false,-1, 127,0);
    tracep->declArray(c+163,"io_sram3_rdata", false,-1, 127,0);
    tracep->declArray(c+148,"Q00", false,-1, 127,0);
    tracep->declArray(c+153,"Q01", false,-1, 127,0);
    tracep->declArray(c+158,"Q10", false,-1, 127,0);
    tracep->declArray(c+163,"Q11", false,-1, 127,0);
    tracep->declArray(c+140,"BWEN", false,-1, 127,0);
    tracep->declBus(c+138,"A", false,-1, 6,0);
    tracep->declArray(c+144,"D", false,-1, 127,0);
    tracep->declBus(c+310,"dcache_wb_data", false,-1, 31,0);
    tracep->declBit(c+344,"allocate_CEN00", false,-1);
    tracep->declBit(c+345,"allocate_CEN01", false,-1);
    tracep->declBit(c+346,"allocate_CEN10", false,-1);
    tracep->declBit(c+347,"allocate_CEN11", false,-1);
    tracep->declBit(c+348,"hit_CEN00", false,-1);
    tracep->declBit(c+349,"hit_CEN01", false,-1);
    tracep->declBit(c+350,"hit_CEN10", false,-1);
    tracep->declBit(c+351,"hit_CEN11", false,-1);
    tracep->declBit(c+139,"WEN00", false,-1);
    tracep->declBit(c+152,"WEN01", false,-1);
    tracep->declBit(c+157,"WEN10", false,-1);
    tracep->declBit(c+162,"WEN11", false,-1);
    tracep->declArray(c+352,"dcache_ram_data", false,-1, 127,0);
    tracep->popNamePrefix(1);
    ...
    tracep->declBit(c+424,"clk", false,-1);
    tracep->declBit(c+425,"rst", false,-1);
    tracep->declBus(c+305,"dcache_tag_i", false,-1, 18,0);
    tracep->declBus(c+138,"dcache_index_i", false,-1, 6,0);
    tracep->declBit(c+341,"dirty_bit_write_i", false,-1);
    tracep->declBit(c+342,"dirty_flush_i", false,-1);
    tracep->declBit(c+308,"dirty_bit_read_o", false,-1);
    tracep->declBus(c+309,"dcache_tag_o", false,-1, 18,0);
    tracep->declBit(c+313,"write_valid_i", false,-1);
    tracep->declBit(c+306,"dcache_hit_o", false,-1);
    tracep->declBus(c+356,"read_tag_full", false,-1, 19,0);
    tracep->declBus(c+309,"read_tag", false,-1, 18,0);
    tracep->declBit(c+308,"read_dirty_bit", false,-1);
    tracep->declBus(c+357,"i", false,-1, 31,0);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("u_ysyx_041514_uncache_check1 ");
    tracep->declBus(c+99,"addr_check_i", false,-1, 31,0);
    tracep->declBit(c+303,"uncache_valid_o", false,-1);
    tracep->popNamePrefix(2);
    ...
    tracep->declBus(c+110,"ram_raddr_icache_o", false,-1, 31,0);
    tracep->declBit(c+111,"ram_raddr_valid_icache_o", false,-1);
    tracep->declBus(c+112,"ram_rmask_icache_o", false,-1, 3,0);
    tracep->declBus(c+113,"ram_rsize_icache_o", false,-1, 3,0);
    tracep->declBus(c+114,"ram_rlen_icache_o", false,-1, 7,0);
    tracep->declBit(c+115,"ram_rdata_ready_icache_i", false,-1);
    tracep->declBus(c+116,"ram_rdata_icache_i", false,-1, 31,0);
    tracep->declBus(c+39,"io_sram4_addr", false,-1, 6,0);
    tracep->declBit(c+476,"io_sram4_cen", false,-1);
    tracep->declBit(c+167,"io_sram4_wen", false,-1);
    tracep->declArray(c+168,"io_sram4_wmask", false,-1, 127,0);
    ...
    tracep->declBit(c+358,"icache_hit", false,-1);
    tracep->declBit(c+359,"uncache", false,-1);
    tracep->declBus(c+468,"CACHE_RST", false,-1, 3,0);
    tracep->declBus(c+563,"CACHE_IDLE", false,-1, 3,0);
    ...
    tracep->declBus(c+360,"uncache_rdata", false,-1, 31,0);
    tracep->declBus(c+361,"icache_state", false,-1, 3,0);
    tracep->declBus(c+362,"blk_addr_reg", false,-1, 5,0);
    tracep->declBus(c+363,"line_idx_reg", false,-1, 6,0);
    tracep->declBus(c+364,"line_tag_reg", false,-1, 18,0);
    tracep->declBit(c+365,"icache_tag_write_valid", false,-1);
    tracep->declBit(c+366,"uncache_data_ready", false,-1);
    tracep->declBus(c+367,"burst_count", false,-1, 3,0);
    tracep->declBit(c+368,"ram_r_handshake", false,-1);
    tracep->declBus(c+369,"burst_count_plus1", false,-1, 3,0);
    tracep->declArray(c+296,"icache_wmask", false,-1, 127,0);
    tracep->declArray(c+172,"icache_wdate", false,-1, 127,0);
    tracep->declBus(c+370,"icache_rdata", false,-1, 31,0);
    ...
    tracep->declBus(c+362,"icache_blk_addr_i", false,-1, 5,0);
    tracep->declArray(c+172,"icache_line_wdata_i", false,-1, 127,0);
    tracep->declArray(c+296,"icache_wmask", false,-1, 127,0);
    tracep->declBus(c+367,"burst_count_i", false,-1, 3,0);
    tracep->declBit(c+368,"icache_wen_i", false,-1);
    tracep->declBus(c+370,"icache_rdata_o", false,-1, 31,0);
    tracep->declBus(c+39,"io_sram4_addr", false,-1, 6,0);
    tracep->declBit(c+476,"io_sram4_cen", false,-1);
    tracep->declBit(c+167,"io_sram4_wen", false,-1);
    tracep->declArray(c+168,"io_sram4_wmask", false,-1, 127,0);
    ...
    tracep->declBit(c+371,"CEN00", false,-1);
    tracep->declBit(c+372,"CEN01", false,-1);
    tracep->declBit(c+373,"CEN10", false,-1);
    tracep->declBit(c+374,"CEN11", false,-1);
    ...
    tracep->declBus(c+39,"A", false,-1, 6,0);
    tracep->declArray(c+172,"D", false,-1, 127,0);
    tracep->declArray(c+375,"icache_ram_data", false,-1, 127,0);
    tracep->declBus(c+379,"word_sel", false,-1, 1,0);
    tracep->popNamePrefix(1);
    ...
    tracep->declBit(c+424,"clk", false,-1);
    tracep->declBit(c+425,"rst", false,-1);
    tracep->declBus(c+364,"icache_tag_i", false,-1, 18,0);
    tracep->declBus(c+363,"icache_index_i", false,-1, 6,0);
    tracep->declBit(c+365,"write_valid_i", false,-1);
    tracep->declBit(c+358,"icache_hit_o", false,-1);
    tracep->declBus(c+380,"read_tag_full", false,-1, 19,0);
    tracep->declBit(c+381,"valid_bit", false,-1);
    tracep->declBus(c+382,"tag_read", false,-1, 18,0);
    tracep->declBus(c+383,"i", false,-1, 31,0);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("u_ysyx_041514_uncache_check ");
    tracep->declBus(c+384,"addr_check_i", false,-1, 31,0);
    tracep->declBit(c+359,"uncache_valid_o", false,-1);
    tracep->popNamePrefix(2);
    ...
    tracep->declBit(c+109,"clint_pc_valid_i", false,-1);
...
VL_ATTR_COLD void Vtop___024root__trace_full_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+84,(vlSelf->top__DOT__id2ex__DOT___bpu_pdt_tag_id_ex_q),32);
    bufp->fullIData(oldp+85,(vlSelf->top__DOT__exu__DOT___alu_out),32);
    bufp->fullIData(oldp+86,(vlSelf->top__DOT__exu__DOT___exc_trap_bus),19);
    bufp->fullIData(oldp+87,(vlSelf->top__DOT__ex2mem__DOT___pc_ex_mem_q),32);
    bufp->fullIData(oldp+88,(vlSelf->top__DOT__ex2mem__DOT___inst_data_ex_mem_q),32);
    bufp->fullIData(oldp+89,(vlSelf->top__DOT__ex2mem__DOT___imm_data_ex_mem_q),32);
    bufp->fullCData(oldp+90,(vlSelf->top__DOT__ex2mem__DOT___rd_idx_ex_mem_q),5);
    bufp->fullIData(oldp+91,(vlSelf->top__DOT__ex2mem__DOT___rs1_data_ex_mem_q),32);
    bufp->fullIData(oldp+92,(vlSelf->top__DOT__ex2mem__DOT___rs2_data_ex_mem_q),32);
    bufp->fullIData(oldp+93,(vlSelf->top__DOT__ex2mem__DOT___alu_data_ex_mem_q),32);
    bufp->fullCData(oldp+94,(vlSelf->top__DOT__ex2mem__DOT___pc_op_ex_mem_q),4);
    bufp->fullCData(oldp+95,(vlSelf->top__DOT__ex2mem__DOT___mem_op_ex_mem_q),4);
    bufp->fullIData(oldp+96,(vlSelf->top__DOT__ex2mem__DOT___trap_bus_ex_mem_q),19);
    bufp->fullIData(oldp+97,(vlSelf->top__DOT__mem_data_mem),32);
    bufp->fullIData(oldp+98,(vlSelf->top__DOT__lsu__DOT___mem_trap_bus),19);
    bufp->fullIData(oldp+99,(vlSelf->top__DOT__lsu__DOT___addr),32);
    bufp->fullBit(oldp+100,(vlSelf->top__DOT__mem_addr_valid));
    bufp->fullCData(oldp+101,(vlSelf->top__DOT__mem_mask),4);
    bufp->fullIData(oldp+102,(vlSelf->top__DOT__mem_rdata),32);
    bufp->fullIData(oldp+103,(vlSelf->top__DOT__mem_wdata),32);
    bufp->fullCData(oldp+104,(vlSelf->top__DOT__lsu__DOT__ls_size),4);
    bufp->fullBit(oldp+105,(vlSelf->top__DOT__mem_write_valid));
    bufp->fullBit(oldp+106,(vlSelf->top__DOT__mem_data_ready));
    bufp->fullIData(oldp+107,(((IData)(vlSelf->top__DOT__rv32_gpr_regfile__DOT___rs1_bypass_valid)
                                ? vlSelf->top__DOT__rv32_gpr_regfile__DOT___write_data
                                : vlSelf->top__DOT__rv32_gpr_regfile__DOT__rf
                               [vlSelf->top__DOT__id2ex__DOT___rs1_idx_id_ex_d])),32);
    bufp->fullIData(oldp+108,(((IData)(vlSelf->top__DOT__rv32_gpr_regfile__DOT___rs2_bypass_valid)
                                ? vlSelf->top__DOT__rv32_gpr_regfile__DOT___write_data
                                : vlSelf->top__DOT__rv32_gpr_regfile__DOT__rf
                               [vlSelf->top__DOT__id2ex__DOT___rs2_idx_id_ex_d])),32);
    bufp->fullBit(oldp+109,(vlSelf->top__DOT__clint_u__DOT___trap_valid));
    bufp->fullIData(oldp+110,(vlSelf->top__DOT__u_icache_top__DOT___ram_raddr_icache_o),32);
    bufp->fullBit(oldp+111,(vlSelf->top__DOT__u_icache_top__DOT___ram_raddr_valid_icache_o));
    bufp->fullCData(oldp+112,(vlSelf->top__DOT__u_icache_top__DOT___ram_rmask_icache_o),4);
    bufp->fullCData(oldp+113,(vlSelf->top__DOT__u_icache_top__DOT___ram_rsize_icache_o),4);
    bufp->fullCData(oldp+114,(vlSelf->top__DOT__u_icache_top__DOT___ram_rlen_icache_o),8);
    bufp->fullBit(oldp+115,(((1U == (IData)(vlSelf->top__DOT__axi_arb__DOT__arb_state)) 
                             & (IData)(vlSelf->top__DOT__axi4_rw__DOT___arb_rdata_ready_o))));
    bufp->fullIData(oldp+116,(vlSelf->top__DOT__ram_rdata_icache),32);
    bufp->fullIData(oldp+117,(vlSelf->top__DOT__u_dcache_top__DOT___ram_raddr_dcache_o),32);
    bufp->fullBit(oldp+118,(vlSelf->top__DOT__u_dcache_top__DOT___ram_raddr_valid_dcache_o));
    bufp->fullCData(oldp+119,(vlSelf->top__DOT__u_dcache_top__DOT___ram_rmask_dcache_o),4);
    bufp->fullCData(oldp+120,(vlSelf->top__DOT__u_dcache_top__DOT___ram_rsize_dcache_o),4);
    bufp->fullCData(oldp+121,(vlSelf->top__DOT__u_dcache_top__DOT___ram_rlen_dcache_o),8);
    bufp->fullBit(oldp+122,(vlSelf->top__DOT__ram_rdata_ready_dcache));
    bufp->fullIData(oldp+123,(vlSelf->top__DOT__ram_rdata_dcache),32);
    bufp->fullIData(oldp+124,(vlSelf->top__DOT__u_dcache_top__DOT___ram_waddr_dcache_o),32);
    bufp->fullBit(oldp+125,(vlSelf->top__DOT__u_dcache_top__DOT___ram_waddr_valid_dcache_o));
    bufp->fullCData(oldp+126,(vlSelf->top__DOT__u_dcache_top__DOT___ram_wmask_dcache_o),4);
    bufp->fullBit(oldp+127,(vlSelf->top__DOT__axi4_rw__DOT___arb_wdata_ready_o));
    bufp->fullCData(oldp+128,(vlSelf->top__DOT__u_dcache_top__DOT___ram_wsize_dcache_o),4);
    bufp->fullCData(oldp+129,(vlSelf->top__DOT__u_dcache_top__DOT___ram_wlen_dcache_o),8);
    bufp->fullIData(oldp+130,(vlSelf->top__DOT__axi_arb__DOT___arb_read_addr_o),32);
    bufp->fullBit(oldp+131,(vlSelf->top__DOT__axi_arb__DOT___arb_raddr_valid_o));
    bufp->fullCData(oldp+132,(vlSelf->top__DOT__axi_arb__DOT___arb_rmask_o),4);
    bufp->fullCData(oldp+133,(vlSelf->top__DOT__axi_arb__DOT___arb_rsize_o),4);
    bufp->fullCData(oldp+134,(vlSelf->top__DOT__axi_arb__DOT___arb_rlen_o),8);
    bufp->fullIData(oldp+135,(vlSelf->top__DOT__axi4_rw__DOT___arb_rdata_o),32);
    bufp->fullBit(oldp+136,(vlSelf->top__DOT__axi4_rw__DOT___arb_rdata_ready_o));
    bufp->fullBit(oldp+137,(vlSelf->top__DOT__axi4_rw__DOT___arb_rlast_o));
    bufp->fullCData(oldp+138,(vlSelf->top__DOT__u_dcache_top__DOT__u_dcache_data__DOT__A),7);
    bufp->fullBit(oldp+139,((1U & (~ (IData)(vlSelf->top__DOT__sram__DOT__SRAM0__DOT__wen)))));
    ...
    bufp->fullWData(oldp+140,(__Vtemp_h27474455__0),128);
    bufp->fullWData(oldp+144,(vlSelf->top__DOT__u_dcache_top__DOT__u_dcache_data__DOT__D),128);
    bufp->fullWData(oldp+148,(vlSelf->top__DOT__io_sram0_rdata),128);
    bufp->fullBit(oldp+152,((1U & (~ (IData)(vlSelf->top__DOT__sram__DOT__SRAM1__DOT__wen)))));
    bufp->fullWData(oldp+153,(vlSelf->top__DOT__io_sram1_rdata),128);
    bufp->fullBit(oldp+157,((1U & (~ (IData)(vlSelf->top__DOT__sram__DOT__SRAM2__DOT__wen)))));
    bufp->fullWData(oldp+158,(vlSelf->top__DOT__io_sram2_rdata),128);
    bufp->fullBit(oldp+162,((1U & (~ (IData)(vlSelf->top__DOT__sram__DOT__SRAM3__DOT__wen)))));
    bufp->fullWData(oldp+163,(vlSelf->top__DOT__io_sram3_rdata),128);
    bufp->fullBit(oldp+167,((1U & (~ (IData)(vlSelf->top__DOT__sram__DOT__SRAM4__DOT__wen)))));
    ...
    bufp->fullWData(oldp+168,(__Vtemp_hf4399207__0),128);
    bufp->fullWData(oldp+172,(vlSelf->top__DOT__u_icache_top__DOT__u_icache_data__DOT__D),128);
    bufp->fullWData(oldp+176,(vlSelf->top__DOT__io_sram4_rdata),128);
    bufp->fullBit(oldp+180,((1U & (~ (IData)(vlSelf->top__DOT__sram__DOT__SRAM5__DOT__wen)))));
    bufp->fullWData(oldp+181,(vlSelf->top__DOT__io_sram5_rdata),128);
    bufp->fullBit(oldp+185,((1U & (~ (IData)(vlSelf->top__DOT__sram__DOT__SRAM6__DOT__wen)))));
    bufp->fullWData(oldp+186,(vlSelf->top__DOT__io_sram6_rdata),128);
    bufp->fullBit(oldp+190,((1U & (~ (IData)(vlSelf->top__DOT__sram__DOT__SRAM7__DOT__wen)))));
    bufp->fullWData(oldp+191,(vlSelf->top__DOT__io_sram7_rdata),128);
    bufp->fullCData(oldp+195,(vlSelf->top__DOT__axi4_rw__DOT__to_aw_size),3);
    bufp->fullCData(oldp+196,(vlSelf->top__DOT__axi4_rw__DOT__axi_wstate),3);
    bufp->fullIData(oldp+197,(vlSelf->top__DOT__axi4_rw__DOT__aw_addr),32);
    bufp->fullBit(oldp+198,(vlSelf->top__DOT__axi4_rw__DOT__aw_valid));
    bufp->fullCData(oldp+199,(vlSelf->top__DOT__axi4_rw__DOT__aw_len),8);
    bufp->fullCData(oldp+200,(vlSelf->top__DOT__axi4_rw__DOT__aw_size),3);
    bufp->fullCData(oldp+201,(vlSelf->top__DOT__axi4_rw__DOT__w_strb),4);
    bufp->fullBit(oldp+202,(vlSelf->top__DOT__axi4_rw__DOT__w_valid));
    bufp->fullBit(oldp+203,(vlSelf->top__DOT__axi4_rw__DOT__w_last));
    bufp->fullBit(oldp+204,(vlSelf->top__DOT__axi4_rw__DOT__b_ready));
    bufp->fullCData(oldp+205,(vlSelf->top__DOT__axi4_rw__DOT__burst_count),8);
    bufp->fullCData(oldp+206,((0xffU & ((IData)(1U) 
                                        + (IData)(vlSelf->top__DOT__axi4_rw__DOT__burst_count)))),8);
    bufp->fullCData(oldp+207,(((1U & (- (IData)((1U 
                               ...
                               | ((2U & (- (IData)(
                                  ...
                                  | (3U & (- (IData)(
                                                     (1U 
                                                      & ((IData)(vlSelf->top__DOT__axi_arb__DOT___arb_rsize_o) 
                                                         >> 3U)))))))),3);
    bufp->fullCData(oldp+208,(vlSelf->top__DOT__axi4_rw__DOT__axi_rstate),3);
    bufp->fullBit(oldp+209,(vlSelf->top__DOT__axi4_rw__DOT__ar_valid));
    bufp->fullIData(oldp+210,(vlSelf->top__DOT__axi4_rw__DOT__ar_addr),32);
    bufp->fullCData(oldp+211,(vlSelf->top__DOT__axi4_rw__DOT__ar_size),3);
    bufp->fullCData(oldp+212,(vlSelf->top__DOT__axi4_rw__DOT__ar_len),8);
    bufp->fullBit(oldp+213,(vlSelf->top__DOT__axi4_rw__DOT__r_ready));
    bufp->fullCData(oldp+214,(vlSelf->top__DOT__axi_arb__DOT__arb_state),2);
    bufp->fullBit(oldp+215,((1U == (IData)(vlSelf->top__DOT__axi_arb__DOT__arb_state))));
    bufp->fullBit(oldp+216,((2U == (IData)(vlSelf->top__DOT__axi_arb__DOT__arb_state))));
    bufp->fullBit(oldp+217,((1U & ((~ ((IData)(vlSelf->top__DOT__u_icache_top__DOT__icache_hit) 
                                       | (IData)(vlSelf->top__DOT__u_icache_top__DOT__uncache_data_ready))) 
                                   | (IData)(vlSelf->top__DOT__mem_addr_valid)))));
    bufp->fullBit(oldp+218,(((IData)(vlSelf->top__DOT__id2ex__DOT___bpu_pdt_res_id_ex_q) 
                             & (vlSelf->top__DOT__id2ex__DOT___bpu_pdt_tag_id_ex_q 
                                == vlSelf->top__DOT__id2ex__DOT___pc_id_ex_q))));
    bufp->fullIData(oldp+219,(vlSelf->top__DOT__exu__DOT___alu_in1),32);
    bufp->fullIData(oldp+220,(vlSelf->top__DOT__exu__DOT___alu_in2),32);
    bufp->fullBit(oldp+221,(vlSelf->top__DOT__exu__DOT___compare_out));
    bufp->fullBit(oldp+222,((8U == (IData)(vlSelf->top__DOT__id2ex__DOT___alu_op_id_ex_q))));
    bufp->fullBit(oldp+223,((6U == (IData)(vlSelf->top__DOT__id2ex__DOT___alu_op_id_ex_q))));
    bufp->fullBit(oldp+224,((7U == (IData)(vlSelf->top__DOT__id2ex__DOT___alu_op_id_ex_q))));
    bufp->fullCData(oldp+225,((0x1fU & vlSelf->top__DOT__exu__DOT___alu_in2)),5);
    bufp->fullIData(oldp+226,((((- (IData)((6U == (IData)(vlSelf->top__DOT__id2ex__DOT___alu_op_id_ex_q)))) 
    ...
    bufp->fullIData(oldp+227,(vlSelf->top__DOT__exu__DOT__u_alu__DOT__u_alu_shift__DOT___shift_num_inv),32);
    bufp->fullIData(oldp+228,(vlSelf->top__DOT__exu__DOT__u_alu__DOT__u_alu_shift__DOT___shifter_res),32);
    bufp->fullIData(oldp+229,(vlSelf->top__DOT__exu__DOT__u_alu__DOT__u_alu_shift__DOT___srl_res),32);
    bufp->fullIData(oldp+230,(vlSelf->top__DOT__ifu__DOT__bpu__DOT__btb_hits),32);
    bufp->fullIData(oldp+231,(vlSelf->top__DOT__ifu__DOT__bpu__DOT__btb_misses),32);
    bufp->fullBit(oldp+232,((0x63U == (0x7fU & vlSelf->top__DOT__u_icache_top__DOT__icache_final_data))));
    bufp->fullBit(oldp+233,((0x6fU == (0x7fU & vlSelf->top__DOT__u_icache_top__DOT__icache_final_data))));
    bufp->fullBit(oldp+234,((0x67U == (0x7fU & vlSelf->top__DOT__u_icache_top__DOT__icache_final_data))));
    bufp->fullIData(oldp+235,((((- (IData)((vlSelf->top__DOT__u_icache_top__DOT__icache_final_data 
                                            >> 0x1fU))) 
                                << 0xcU) | ((0x800U 
                                            ...
                                            | ((0x7e0U 
                                               ...
                                               | (0x1eU 
                                                  & (vlSelf->top__DOT__u_icache_top__DOT__icache_final_data 
                                                     >> 7U)))))),32);
    bufp->fullCData(oldp+236,(vlSelf->top__DOT__ifu__DOT__bpu__DOT__t0_index_u),8);
    bufp->fullCData(oldp+237,(vlSelf->top__DOT__ifu__DOT__bpu__DOT__t1_index_u),8);
    bufp->fullSData(oldp+238,(vlSelf->top__DOT__ifu__DOT__bpu__DOT__t0_tag_u),10);
    bufp->fullSData(oldp+239,(vlSelf->top__DOT__ifu__DOT__bpu__DOT__t1_tag_u),10);
    bufp->fullSData(oldp+240,(vlSelf->top__DOT__ifu__DOT__bpu__DOT__bm_index_u),9);
    bufp->fullCData(oldp+241,(vlSelf->top__DOT__ifu__DOT__bpu__DOT__btb_index_u),8);
    bufp->fullIData(oldp+242,(vlSelf->top__DOT__ifu__DOT__bpu__DOT__btb_tag_u),22);
    bufp->fullIData(oldp+243,(((0U < vlSelf->top__DOT__ifu__DOT__bpu__DOT____VdfgTmp_hb3e3931f__0)
                                ...
                                : 0U)),32);
    bufp->fullBit(oldp+244,(vlSelf->top__DOT__lsu__DOT__ls_signed));
    bufp->fullIData(oldp+245,(((IData)(vlSelf->top__DOT__mem_data_ready)
                                ? vlSelf->top__DOT__mem_rdata
                                : 0U)),32);
    bufp->fullIData(oldp+246,((((- (IData)((IData)(vlSelf->top__DOT__lsu__DOT___ls8byte))) 
                                      ...
                                      ((IData)(vlSelf->top__DOT__mem_data_ready)
                                        ...
                                        : 0U))) | (
                                                   ...
                                                   & ((IData)(vlSelf->top__DOT__mem_data_ready)
                                                       ? vlSelf->top__DOT__mem_rdata
                                                       : 0U))))),32);
    bufp->fullBit(oldp+247,(vlSelf->top__DOT__lsu__DOT___ls8byte));
    bufp->fullBit(oldp+248,(vlSelf->top__DOT__lsu__DOT___ls16byte));
    bufp->fullBit(oldp+249,(vlSelf->top__DOT__lsu__DOT___ls32byte));
    bufp->fullCData(oldp+250,(vlSelf->top__DOT__lsu__DOT__addr_last2),2);
    bufp->fullCData(oldp+251,(vlSelf->top__DOT__lsu__DOT___mask),4);
    bufp->fullCData(oldp+252,((0xfU & ((IData)(vlSelf->top__DOT__lsu__DOT___mask) 
                                       << (IData)(vlSelf->top__DOT__lsu__DOT__addr_last2)))),4);
    bufp->fullBit(oldp+253,(((IData)(vlSelf->top__DOT__lsu__DOT___isload) 
                             | (IData)(vlSelf->top__DOT__lsu__DOT___isstore))));
    bufp->fullIData(oldp+254,(vlSelf->top__DOT__lsu__DOT__lsu_ext_store__DOT___ext_data),32);
    bufp->fullIData(oldp+255,(vlSelf->top__DOT__rv32_gpr_regfile__DOT__rf[0]),32);
    bufp->fullIData(oldp+256,(vlSelf->top__DOT__rv32_gpr_regfile__DOT__rf[1]),32);
    bufp->fullIData(oldp+257,(vlSelf->top__DOT__rv32_gpr_regfile__DOT__rf[2]),32);
    bufp->fullIData(oldp+258,(vlSelf->top__DOT__rv32_gpr_regfile__DOT__rf[3]),32);
    bufp->fullIData(oldp+259,(vlSelf->top__DOT__rv32_gpr_regfile__DOT__rf[4]),32);
    bufp->fullIData(oldp+260,(vlSelf->top__DOT__rv32_gpr_regfile__DOT__rf[5]),32);
    bufp->fullIData(oldp+261,(vlSelf->top__DOT__rv32_gpr_regfile__DOT__rf[6]),32);
    bufp->fullIData(oldp+262,(vlSelf->top__DOT__rv32_gpr_regfile__DOT__rf[7]),32);
    bufp->fullIData(oldp+263,(vlSelf->top__DOT__rv32_gpr_regfile__DOT__rf[8]),32);
    bufp->fullIData(oldp+264,(vlSelf->top__DOT__rv32_gpr_regfile__DOT__rf[9]),32);
    bufp->fullIData(oldp+265,(vlSelf->top__DOT__rv32_gpr_regfile__DOT__rf[10]),32);
    bufp->fullIData(oldp+266,(vlSelf->top__DOT__rv32_gpr_regfile__DOT__rf[11]),32);
    bufp->fullIData(oldp+267,(vlSelf->top__DOT__rv32_gpr_regfile__DOT__rf[12]),32);
    bufp->fullIData(oldp+268,(vlSelf->top__DOT__rv32_gpr_regfile__DOT__rf[13]),32);
    bufp->fullIData(oldp+269,(vlSelf->top__DOT__rv32_gpr_regfile__DOT__rf[14]),32);
    bufp->fullIData(oldp+270,(vlSelf->top__DOT__rv32_gpr_regfile__DOT__rf[15]),32);
    bufp->fullIData(oldp+271,(vlSelf->top__DOT__rv32_gpr_regfile__DOT__rf[16]),32);
    bufp->fullIData(oldp+272,(vlSelf->top__DOT__rv32_gpr_regfile__DOT__rf[17]),32);
    bufp->fullIData(oldp+273,(vlSelf->top__DOT__rv32_gpr_regfile__DOT__rf[18]),32);
    bufp->fullIData(oldp+274,(vlSelf->top__DOT__rv32_gpr_regfile__DOT__rf[19]),32);
    bufp->fullIData(oldp+275,(vlSelf->top__DOT__rv32_gpr_regfile__DOT__rf[20]),32);
    bufp->fullIData(oldp+276,(vlSelf->top__DOT__rv32_gpr_regfile__DOT__rf[21]),32);
    bufp->fullIData(oldp+277,(vlSelf->top__DOT__rv32_gpr_regfile__DOT__rf[22]),32);
    bufp->fullIData(oldp+278,(vlSelf->top__DOT__rv32_gpr_regfile__DOT__rf[23]),32);
    bufp->fullIData(oldp+279,(vlSelf->top__DOT__rv32_gpr_regfile__DOT__rf[24]),32);
    bufp->fullIData(oldp+280,(vlSelf->top__DOT__rv32_gpr_regfile__DOT__rf[25]),32);
    bufp->fullIData(oldp+281,(vlSelf->top__DOT__rv32_gpr_regfile__DOT__rf[26]),32);
    bufp->fullIData(oldp+282,(vlSelf->top__DOT__rv32_gpr_regfile__DOT__rf[27]),32);
    bufp->fullIData(oldp+283,(vlSelf->top__DOT__rv32_gpr_regfile__DOT__rf[28]),32);
    bufp->fullIData(oldp+284,(vlSelf->top__DOT__rv32_gpr_regfile__DOT__rf[29]),32);
    bufp->fullIData(oldp+285,(vlSelf->top__DOT__rv32_gpr_regfile__DOT__rf[30]),32);
    bufp->fullIData(oldp+286,(vlSelf->top__DOT__rv32_gpr_regfile__DOT__rf[31]),32);
    bufp->fullBit(oldp+287,(vlSelf->top__DOT__sram__DOT__SRAM0__DOT__wen));
    bufp->fullWData(oldp+288,(vlSelf->top__DOT__sram__DOT__SRAM0__DOT__bwen),128);
    bufp->fullBit(oldp+292,(vlSelf->top__DOT__sram__DOT__SRAM1__DOT__wen));
    bufp->fullBit(oldp+293,(vlSelf->top__DOT__sram__DOT__SRAM2__DOT__wen));
    bufp->fullBit(oldp+294,(vlSelf->top__DOT__sram__DOT__SRAM3__DOT__wen));
    bufp->fullBit(oldp+295,(vlSelf->top__DOT__sram__DOT__SRAM4__DOT__wen));
    bufp->fullWData(oldp+296,(vlSelf->top__DOT__sram__DOT__SRAM4__DOT__bwen),128);
    bufp->fullBit(oldp+300,(vlSelf->top__DOT__sram__DOT__SRAM5__DOT__wen));
    bufp->fullBit(oldp+301,(vlSelf->top__DOT__sram__DOT__SRAM6__DOT__wen));
    bufp->fullBit(oldp+302,(vlSelf->top__DOT__sram__DOT__SRAM7__DOT__wen));
    bufp->fullBit(oldp+303,((0xa0000000U <= vlSelf->top__DOT__lsu__DOT___addr)));
    bufp->fullCData(oldp+304,(((0U == (IData)(vlSelf->top__DOT__ex2mem__DOT___mem_op_ex_mem_q))
                                ? 0U : (0x3fU & vlSelf->top__DOT__ex2mem__DOT___alu_data_ex_mem_q))),6);
    bufp->fullIData(oldp+305,(vlSelf->top__DOT__u_dcache_top__DOT__cache_line_tag),19);
    bufp->fullBit(oldp+306,((vlSelf->top__DOT__u_dcache_top__DOT__cache_line_tag 
                             == (0x7ffffU & vlSelf->top__DOT__u_dcache_top__DOT__u_dcache_tag__DOT__read_tag_full))));
    bufp->fullIData(oldp+307,((((- (IData)((1U & ((IData)(vlSelf->top__DOT__mem_mask) 
                                                  >> 3U)))) 
                                << 0x18U) | ((0xff0000U 
                                              & ((- (IData)(
                                                            (1U 
    ...
    bufp->fullBit(oldp+308,((1U & (vlSelf->top__DOT__u_dcache_top__DOT__u_dcache_tag__DOT__read_tag_full 
                                   >> 0x13U))));
    bufp->fullIData(oldp+309,((0x7ffffU & vlSelf->top__DOT__u_dcache_top__DOT__u_dcache_tag__DOT__read_tag_full)),19);
    bufp->fullIData(oldp+310,(vlSelf->top__DOT__u_dcache_top__DOT__u_dcache_data__DOT__dcache_wb_data),32);
    bufp->fullCData(oldp+311,(vlSelf->top__DOT__u_dcache_top__DOT__dcache_state),4);
    bufp->fullCData(oldp+312,(vlSelf->top__DOT__u_dcache_top__DOT__blk_addr_reg),6);
    bufp->fullBit(oldp+313,(vlSelf->top__DOT__u_dcache_top__DOT__dcache_tag_wen));
    bufp->fullBit(oldp+314,(vlSelf->top__DOT__u_dcache_top__DOT__dcache_data_ready));
    bufp->fullWData(oldp+315,(vlSelf->top__DOT__u_dcache_top__DOT__dcache_wdata_writehit),128);
    bufp->fullIData(oldp+319,(vlSelf->top__DOT__u_dcache_top__DOT__uncache_rdata),32);
    bufp->fullBit(oldp+320,(vlSelf->top__DOT__u_dcache_top__DOT__dcache_data_wen));
    bufp->fullBit(oldp+321,(vlSelf->top__DOT__u_dcache_top__DOT__dcache_write_hit_valid));
    bufp->fullWData(oldp+322,(vlSelf->top__DOT__u_dcache_top__DOT__dcache_wmask_writehit),128);
    bufp->fullCData(oldp+326,(vlSelf->top__DOT__u_dcache_top__DOT__burst_count),4);
    bufp->fullCData(oldp+327,((0xfU & ((IData)(1U) 
                                       + (IData)(vlSelf->top__DOT__u_dcache_top__DOT__burst_count)))),4);
    bufp->fullBit(oldp+328,(vlSelf->top__DOT__u_dcache_top__DOT__ram_r_handshake));
    bufp->fullBit(oldp+329,(vlSelf->top__DOT__u_dcache_top__DOT__ram_w_handshake));
    ...
    bufp->fullWData(oldp+330,(__Vtemp_h3c33dbb8__0),128);
    if ((0U == (3U & (IData)(vlSelf->top__DOT__u_dcache_top__DOT__burst_count)))) {
    ...
    bufp->fullWData(oldp+334,(__Vtemp_h63c513ac__0),128);
    bufp->fullBit(oldp+338,((3U == (IData)(vlSelf->top__DOT__u_dcache_top__DOT__dcache_state))));
    bufp->fullBit(oldp+339,((4U == (IData)(vlSelf->top__DOT__u_dcache_top__DOT__dcache_state))));
    bufp->fullBit(oldp+340,(vlSelf->top__DOT__u_dcache_top__DOT__dcache_wwen));
    bufp->fullBit(oldp+341,(vlSelf->top__DOT__u_dcache_top__DOT___dirty_bit_write));
    bufp->fullBit(oldp+342,(vlSelf->top__DOT__u_dcache_top__DOT___dirty_flush));
    ...
    bufp->fullIData(oldp+343,((((0U == (0x1fU & (((0U 
                               ...
                               | (__Vtemp_hc53e4bea__0[
                                  ...
                                  (0x1fU & (((0U == (IData)(vlSelf->top__DOT__ex2mem__DOT___mem_op_ex_mem_q))
                                             ...
                                             (0xfU 
                                              & vlSelf->top__DOT__ex2mem__DOT___alu_data_ex_mem_q)) 
                                            << 3U))))),32);
    bufp->fullBit(oldp+344,((IData)(((0U == (0xcU & (IData)(vlSelf->top__DOT__u_dcache_top__DOT__burst_count))) 
                                     & (3U == (IData)(vlSelf->top__DOT__u_dcache_top__DOT__dcache_state))))));
    bufp->fullBit(oldp+345,((IData)(((4U == (0xcU & (IData)(vlSelf->top__DOT__u_dcache_top__DOT__burst_count))) 
                                     & (3U == (IData)(vlSelf->top__DOT__u_dcache_top__DOT__dcache_state))))));
    bufp->fullBit(oldp+346,((IData)(((8U == (0xcU & (IData)(vlSelf->top__DOT__u_dcache_top__DOT__burst_count))) 
                                     & (3U == (IData)(vlSelf->top__DOT__u_dcache_top__DOT__dcache_state))))));
    bufp->fullBit(oldp+347,((IData)(((0xcU == (0xcU 
                                               & (IData)(vlSelf->top__DOT__u_dcache_top__DOT__burst_count))) 
                                     & (3U == (IData)(vlSelf->top__DOT__u_dcache_top__DOT__dcache_state))))));
    bufp->fullBit(oldp+348,(vlSelf->top__DOT__u_dcache_top__DOT__u_dcache_data__DOT__hit_CEN00));
    bufp->fullBit(oldp+349,(vlSelf->top__DOT__u_dcache_top__DOT__u_dcache_data__DOT__hit_CEN01));
    bufp->fullBit(oldp+350,(vlSelf->top__DOT__u_dcache_top__DOT__u_dcache_data__DOT__hit_CEN10));
    bufp->fullBit(oldp+351,(vlSelf->top__DOT__u_dcache_top__DOT__u_dcache_data__DOT__hit_CEN11));
    ...
    __Vtemp_he342d181__0[3U] = (((- (IData)((IData)(vlSelf->top__DOT__u_dcache_top__DOT__u_dcache_data__DOT__hit_CEN00))) 
                                ...
                                | (((- (IData)((IData)(vlSelf->top__DOT__u_dcache_top__DOT__u_dcache_data__DOT__hit_CEN01))) 
                                   ...
                                   | (((- (IData)((IData)(vlSelf->top__DOT__u_dcache_top__DOT__u_dcache_data__DOT__hit_CEN10))) 
                                      ...
                                      | ((- (IData)((IData)(vlSelf->top__DOT__u_dcache_top__DOT__u_dcache_data__DOT__hit_CEN11))) 
                                         & vlSelf->top__DOT__io_sram3_rdata[3U]))));
    bufp->fullWData(oldp+352,(__Vtemp_he342d181__0),128);
    bufp->fullIData(oldp+356,(vlSelf->top__DOT__u_dcache_top__DOT__u_dcache_tag__DOT__read_tag_full),20);
    bufp->fullIData(oldp+357,(vlSelf->top__DOT__u_dcache_top__DOT__u_dcache_tag__DOT__i),32);
    bufp->fullBit(oldp+358,(vlSelf->top__DOT__u_icache_top__DOT__icache_hit));
    bufp->fullBit(oldp+359,((0xa0000000U <= vlSelf->top__DOT__u_icache_top__DOT____Vcellinp__u_ysyx_041514_uncache_check__addr_check_i)));
    bufp->fullIData(oldp+360,(vlSelf->top__DOT__u_icache_top__DOT__uncache_rdata),32);
    bufp->fullCData(oldp+361,(vlSelf->top__DOT__u_icache_top__DOT__icache_state),4);
    bufp->fullCData(oldp+362,(vlSelf->top__DOT__u_icache_top__DOT__blk_addr_reg),6);
    bufp->fullCData(oldp+363,(vlSelf->top__DOT__u_icache_top__DOT__line_idx_reg),7);
    bufp->fullIData(oldp+364,(vlSelf->top__DOT__u_icache_top__DOT__line_tag_reg),19);
    bufp->fullBit(oldp+365,(vlSelf->top__DOT__u_icache_top__DOT__icache_tag_write_valid));
    bufp->fullBit(oldp+366,(vlSelf->top__DOT__u_icache_top__DOT__uncache_data_ready));
    bufp->fullCData(oldp+367,(vlSelf->top__DOT__u_icache_top__DOT__burst_count),4);
    bufp->fullBit(oldp+368,(vlSelf->top__DOT__u_icache_top__DOT__ram_r_handshake));
    bufp->fullCData(oldp+369,((0xfU & ((IData)(1U) 
    ...
    bufp->fullIData(oldp+370,(__Vtemp_hddfc193a__0[
                              (3U & ((IData)(vlSelf->top__DOT__u_icache_top__DOT__blk_addr_reg) 
                                     >> 2U))]),32);
    bufp->fullBit(oldp+371,((0U != (3U & ((IData)(vlSelf->top__DOT__u_icache_top__DOT__blk_addr_reg) 
                                          >> 4U)))));
    bufp->fullBit(oldp+372,((1U != (3U & ((IData)(vlSelf->top__DOT__u_icache_top__DOT__blk_addr_reg) 
                                          >> 4U)))));
    bufp->fullBit(oldp+373,((2U != (3U & ((IData)(vlSelf->top__DOT__u_icache_top__DOT__blk_addr_reg) 
                                          >> 4U)))));
    bufp->fullBit(oldp+374,((3U != (3U & ((IData)(vlSelf->top__DOT__u_icache_top__DOT__blk_addr_reg) 
                                          >> 4U)))));
                                                    ...
                                                    (3U 
                                                     ...
                                                     (3U 
                                                      & ((IData)(vlSelf->top__DOT__u_icache_top__DOT__blk_addr_reg) 
                                                         >> 4U))))) 
                                         & vlSelf->top__DOT__io_sram7_rdata[3U]))));
    bufp->fullWData(oldp+375,(__Vtemp_h6182a1bb__0),128);
    bufp->fullCData(oldp+379,((3U & ((IData)(vlSelf->top__DOT__u_icache_top__DOT__blk_addr_reg) 
                                     >> 2U))),2);
    bufp->fullIData(oldp+380,(vlSelf->top__DOT__u_icache_top__DOT__u_icache_tag__DOT__read_tag_full),20);
    bufp->fullBit(oldp+381,((1U & (vlSelf->top__DOT__u_icache_top__DOT__u_icache_tag__DOT__read_tag_full 
                                   >> 0x13U))));
    bufp->fullIData(oldp+382,((0x7ffffU & vlSelf->top__DOT__u_icache_top__DOT__u_icache_tag__DOT__read_tag_full)),19);
    bufp->fullIData(oldp+383,(vlSelf->top__DOT__u_icache_top__DOT__u_icache_tag__DOT__i),32);
    bufp->fullIData(oldp+384,(vlSelf->top__DOT__u_icache_top__DOT____Vcellinp__u_ysyx_041514_uncache_check__addr_check_i),32);
    bufp->fullSData(oldp+385,(vlSelf->top__DOT__ifu__DOT__bpu__DOT__global_history),16);
    bufp->fullCData(oldp+386,(vlSelf->top__DOT__ifu__DOT__bpu__DOT__ras_sp),6);
    bufp->fullCData(oldp+387,(vlSelf->top__DOT__ifu__DOT__bpu__DOT__pred_ras_sp),6);
    bufp->fullCData(oldp+388,(vlSelf->top__DOT__ifu__DOT__bpu__DOT__provider_history_reg),2);
    bufp->fullIData(oldp+389,(vlSelf->top__DOT__ifu__DOT__bpu__DOT__total_branches),32);
    bufp->fullIData(oldp+390,(vlSelf->top__DOT__ifu__DOT__bpu__DOT__correct_predictions),32);
    bufp->fullIData(oldp+391,(vlSelf->top__DOT__ifu__DOT__bpu__DOT__bimodal_hits),32);
    bufp->fullIData(oldp+392,(vlSelf->top__DOT__ifu__DOT__bpu__DOT__t0_hits),32);
    bufp->fullIData(oldp+393,(vlSelf->top__DOT__ifu__DOT__bpu__DOT__t1_hits),32);
    bufp->fullBit(oldp+394,(vlSelf->top__DOT__ifu__DOT__bpu__DOT__ras_forward_valid));
    bufp->fullIData(oldp+395,(vlSelf->top__DOT__ifu__DOT__bpu__DOT__ras_forward_data),32);
    bufp->fullBit(oldp+396,(vlSelf->top__DOT__ifu__DOT__bpu__DOT__ras_forward_used));
    bufp->fullCData(oldp+397,(vlSelf->top__DOT__ifu__DOT__bpu__DOT__next_sp),6);
    bufp->fullBit(oldp+398,(vlSelf->top__DOT__ifu__DOT__bpu__DOT__pop_occurred));
    bufp->fullCData(oldp+399,(vlSelf->top__DOT__ifu__DOT__bpu__DOT__pop_index),6);
