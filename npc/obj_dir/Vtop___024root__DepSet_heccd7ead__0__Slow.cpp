...
VL_ATTR_COLD void Vtop___024root___dump_triggers__stl(Vtop___024root* vlSelf) {
    ...
    if (vlSelf->__VstlTriggered.at(1U)) {
        VL_DBG_MSGF("         'stl' region trigger index 1 is active: @([hybrid] top.exu.bpu_pc_wrong)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void Vtop___024root___dump_triggers__ico(Vtop___024root* vlSelf) {
    ...
    if (vlSelf->__VicoTriggered.at(1U)) {
        VL_DBG_MSGF("         'ico' region trigger index 1 is active: @([hybrid] top.exu.bpu_pc_wrong)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void Vtop___024root___dump_triggers__act(Vtop___024root* vlSelf) {
    ...
    if (vlSelf->__VactTriggered.at(2U)) {
        VL_DBG_MSGF("         'act' region trigger index 2 is active: @([hybrid] top.exu.bpu_pc_wrong)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void Vtop___024root___dump_triggers__nba(Vtop___024root* vlSelf) {
    ...
    if (vlSelf->__VnbaTriggered.at(2U)) {
        VL_DBG_MSGF("         'nba' region trigger index 2 is active: @([hybrid] top.exu.bpu_pc_wrong)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->top__DOT__ifu__DOT__bpu__DOT__ex_next_ras_top = 0;
    ...
    vlSelf->__Vdly__top__DOT__ifu__DOT__bpu__DOT__ras_forward_valid = 0;
    vlSelf->__Vdly__top__DOT__ifu__DOT__bpu__DOT__ras_forward_data = 0;
    vlSelf->__Vdly__top__DOT__ifu__DOT__bpu__DOT__ras_forward_used = 0;
    vlSelf->__Vdly__top__DOT__ifu__DOT__bpu__DOT__global_history = 0;
    vlSelf->__Vdly__top__DOT__ifu__DOT__bpu__DOT__provider_history_reg = 0;
    ...
    vlSelf->__Vdly__top__DOT__ifu__DOT__bpu__DOT__ras_sp = 0;
    vlSelf->__Vdlyvdim0__top__DOT__ifu__DOT__bpu__DOT__ras__v0 = 0;
    vlSelf->__Vdlyvval__top__DOT__ifu__DOT__bpu__DOT__ras__v0 = 0;
    vlSelf->__Vdlyvset__top__DOT__ifu__DOT__bpu__DOT__ras__v0 = 0;
    vlSelf->__Vtrigrprev__TOP__top__DOT__exu__DOT__bpu_pc_wrong = 0;
